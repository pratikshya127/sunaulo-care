    ...
    <div className="hero-gradient flex min-h-screen items-center justify-center px-4">
      <div className="glass-card max-w-md rounded-3xl p-10 text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground transition-all hover:opacity-90 shadow-glow"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Sunaulo — Caring Beyond Medicine" },
      {
        name: "description",
        content:
          "Sunaulo is a premium elderly care platform connecting families, caregivers, and seniors with smart health monitoring, medicine reminders, and SOS alerts.",
      },
      { name: "author", content: "Sunaulo" },
      { property: "og:title", content: "Sunaulo — Caring Beyond Medicine" },
      {
        property: "og:description",
        content:
          "Smart healthcare monitoring for elderly care — medicine reminders, vitals tracking, voice messages, and emergency SOS.",
      },
